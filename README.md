...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-8%2C905%20rows-8250df">
...
> **Important:** this repository is a **public 8,905-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,622,080 domains** on the canonical page below.

**Public extract:** 8,905 rows · **Live catalog:** 5,622,080 domains
...
<p align="center">
  ...
  <a href="https://unique.domains/domains/tld/town?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_town_oneword_domains&utm_content=top_create_radar"><b>🔔 Create Radar</b></a> ·
  <a href="https://unique.domains/domains/tld/town?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_town_oneword_domains&utm_content=top_start_project"><b>🚀 Start a Project</b></a> ·
  <b>⬇️ Download sample</b>: <a href="./town.csv">CSV</a> / <a href="./town.json">JSON</a>
</p>

<p align="center">
  <a href="https://unique.domains/technology?utm_source=github&utm_medium=referral&utm_campaign=repo_town_oneword_domains&utm_content=top_methodology">Methodology</a> ·
  <a href="https://unique.domains/api?utm_source=github&utm_medium=referral&utm_campaign=repo_town_oneword_domains&utm_content=top_api_docs">API docs</a>
</p>
...
- **Investors:** [Create a Radar from this exact .TOWN search](https://unique.domains/domains/tld/town?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_town_oneword_domains&utm_content=top_create_radar)
- **Founders:** [Start a Project from this exact .TOWN search](https://unique.domains/domains/tld/town?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_town_oneword_domains&utm_content=top_start_project)
- **Researchers / builders:** [Download CSV](./town.csv) or [Download JSON](./town.json)
...
- `town.csv` — public CSV extract (8,905 rows)
- `town.json` — public JSON extract (8,905 rows)
...
| ----------------------- | ------------------------------------------------ |
| 8,905-row public sample | 5,622,080 live domains                           |
...
| data.town     | resell    | —         | —             | 70             | 60     | 4      | Porkbun LLC       |
...
> Unique Domains. *Available .TOWN One-Word Domains*. Version 2026-04-09. Public GitHub extract for the exact Unique Domains search represented by this repository.
